...
export default class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            recipeList: [
                {
                    imgUrl: "../src/img/tabbouleh_01.jpg",
                    title: "TABBOULEH",
                ...
                {
                    imgUrl: "../src/img/kasza_bulgur_z_warzywami_fasolka_01_0.jpg",
                ...
                {
                    imgUrl: "../src/img/quinoa_po_meksykansku_01.jpg",
                ...
                {
                    imgUrl: "../src/img/ryz_smazony_z_krewetkami_mango_01_0.jpg",
